...
public class JSRTest2 extends JFrame implements ActionListener {
  ...
  public JSRTest2() throws Exception {
...
//     System.out.println ("Closing Connection 6");
   ...
   public void actionPerformed(ActionEvent e) {
     try {
       if (e.getSource() == m_protocols) chooseProtocol();
         ...
         if(streamCon instanceof RFCommConnection) {
           is = ((RFCommConnection)streamCon).getInputStream();
           os = ((RFCommConnection)streamCon).getOutputStream();
           if (this.receiverThread != null) { receiverThread.stopReading(); receiverThread = null; }
   ...
   public static void main(String[] args) throws Exception {
     ...
     JSRTest2 JSRTest1 = new JSRTest2();
  }
}
